 ...
 */
export async function generateRequest(requestsDir, resourceName, resourcePascalName, requestType) {
 ...
 */
function generateStoreRequest(resourceName, resourcePascalName) {
 ...
 */
function generateGetAllRequest(resourceName, resourcePascalName) {
    const pluralPascalName = pluralize(resourcePascalName);
    return `import { defineRequestValidator } from "~~/server/utils/validation";
import { z } from 'zod';
 ...
 */
function generateGetOneRequest(resourceName, resourcePascalName) {
    return `import { defineRequestValidator } from "~~/server/utils/validation";
import { z } from 'zod';
 ...
 */
function generateUpdateRequest(resourceName, resourcePascalName) {
    return `import { defineRequestValidator } from "~~/server/utils/validation";
import { z } from 'zod';
 ...
 */
function generateDeleteRequest(resourceName, resourcePascalName) {
    return `import { defineRequestValidator } from "~~/server/utils/validation";
import { z } from 'zod';
