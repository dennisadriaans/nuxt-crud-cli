 ...
 */
export async function generateHandler(handlersDir, resourceName, resourcePascalName, handlerType) {
 ...
 */
function generateCreateHandler(resourceName, resourcePascalName) {
 ...
 */
function generateGetAllHandler(resourceName, resourcePascalName) {
    return `import type { H3Event } from 'h3';
import { use${resourcePascalName}Controller } from "../${resourcePascalName}Controller";
 ...
 */
function generateGetOneHandler(resourceName, resourcePascalName) {
    return `import type { H3Event } from 'h3';
import { use${resourcePascalName}Controller } from "../${resourcePascalName}Controller";
 ...
 */
function generateUpdateHandler(resourceName, resourcePascalName) {
    return `import type { H3Event } from 'h3';
import { use${resourcePascalName}Controller } from "../${resourcePascalName}Controller";
 ...
 */
function generateDeleteHandler(resourceName, resourcePascalName) {
    return `import type { H3Event } from 'h3';
import { use${resourcePascalName}Controller } from "../${resourcePascalName}Controller";
